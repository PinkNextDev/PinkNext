...
This will build pinkcoin-qt as well, if the dependencies are met.
...
If you want to build pinkcoin-qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a pinkcoin-qt executable will be
built by default.
