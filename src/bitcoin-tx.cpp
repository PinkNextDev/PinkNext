...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " pinkcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  pinkcoin-tx [options] <hex-tx> [commands]  Update hex-encoded pinkcoin transaction\n" +
            "or:     pinkcoin-tx [options] -create [commands]   Create hex-encoded pinkcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded pinkcoin transaction
