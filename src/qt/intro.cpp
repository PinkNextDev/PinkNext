    ...
    m_chain_state_size(chain_state_size)
{
    ...
    ui->sizeWarningLabel->setText(
        tr("%1 will download and store a copy of the Pinkcoin block chain.").arg(tr(PACKAGE_NAME)) + " " +
...
bool Intro::pickDataDirectory(interfaces::Node& node)
{
     ...
     * override -datadir in the pinkcoin.conf file in the default data directory
     * (to be consistent with pinkcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory()) {
